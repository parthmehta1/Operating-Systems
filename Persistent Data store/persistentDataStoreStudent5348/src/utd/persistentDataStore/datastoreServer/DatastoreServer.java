...
public class DatastoreServer
{
	...
	private ServerCommand dispatchCommand(InputStream inputStream) throws ServerException, IOException
	{
		...
		switch(result)
		{
		case "write":     ServerCommand writeCmd =new WriteCommand();
		 			      return writeCmd;
		case "read":      ServerCommand readCmd = new ReadCommand();
					      return readCmd;
		case "delete":    ServerCommand deleteCmd = new DeleteCommand();
					      return deleteCmd;
		case "directory": ServerCommand DRC = new DirectoryCommand();
						  return DRC;
